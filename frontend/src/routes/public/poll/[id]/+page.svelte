		...
		<div class="max-w-4xl mx-auto py-8 px-4">
			...
			{#if isPollOpen()}
				<div class="mt-6 bg-red-50 border border-red-200 rounded-lg p-6">
					<div class="flex">
						<svg class="h-6 w-6 text-red-400 mt-0.5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
							<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
						</svg>
						<div class="ml-3">
							<h3 class="text-lg font-medium text-red-900">Ready to Vote?</h3>
			...
			<div class="mt-8 text-center text-sm text-gray-500">
				<p>Powered by <a href="/" class="text-red-600 hover:text-red-500">RankedChoice</a> - Secure, transparent, democratic voting</p>
			</div>
		</div>
	{/if}
</div>
